...
def assign_data():
    ...
    med_avg_profit_by_zipcode = dataframes_list[11]
    med_avg_profit_by_zipcode_season = dataframes_list[12]
    med_avg_profit_by_zipcode_ = med_avg_profit_by_zipcode[['avg_profit', 'zipcode']].rename({'avg_profit':'AVG_PROFIT', 'zipcode':'ZIP'}, axis=1)
    
    return df_buy,df_geo, df_profit, df_sell, df_sell_final, df, med_avg_profit_by_zipcode, med_avg_profit_by_zipcode_season, med_avg_profit_by_zipcode_  
####################################################################################################################################################################################################
# SUGGESTION
...
if __name__ == '__main__':
    ...
    # ASSIGN DATA
    df_buy,df_geo,df_profit,df_sell,df_sell_final,df,med_avg_profit_by_zipcode,med_avg_profit_by_zipcode_season,med_avg_profit_by_zipcode_ = assign_data()
